...
In \ref{app:frequency_area} \ref{fig:appendix:high_E_bridge_flasholet} it is seen that the smallest significant signal is -59.11 dBu \todo[inline]{find SI}. To convert dBu to amplitude equation \ref{eq:dBu_to_amplitude} is used \citep{dB}.
