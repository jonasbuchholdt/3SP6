\section{Description of Different DSP Devices}
...
\todo[inline]{Sebastian: Is there any major thing that makes the Raspberry Pi an advantage?}
...
\begin{equation}\label{eq:MOPS}
    ...
    \startexplain
        \explain{$DSP_{speed}$ is the \gls{dsp}'s processing power}{1}
...
\todo[inline]{Sebastian : If 10 MIPS is not a number always used to describe the relation between MIPS and MOPS then we have to generalize}
