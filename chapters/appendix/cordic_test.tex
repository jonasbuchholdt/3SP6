...
The materials were set up as in \autoref{chap:effect_test_response} \autoref{fig:appendix:dsp_frequency_response}, where only VXX \todo[inline]{insert when figure is done!} was measured.
