...
On  \autoref{fig:appendix:low_E_neck} it is seen that the lowest significant frequency is around \SI{80}{\hertz} and the highest significant frequency around \SI{400}{\hertz}, when playing the low E note on the guitar, using the neck pickup.
...
On  \autoref{fig:appendix:low_E_bridge} it is seen that the lowest significant frequency is around \SI{80}{\hertz} and the highest significant frequency around \SI{730}{\hertz}, when playing the low E note on the guitar, using the bridge pickup.
...
On  \autoref{fig:appendix:high_Cis_neck} it is seen that the lowest significant frequency is around \SI{1100}{\hertz} and the highest significant frequency around \SI{4400}{\hertz}, when playing the high C\# note on the guitar, using the neck pickup.
...
On  \autoref{fig:appendix:high_Cis_bridge} it is seen that the lowest significant frequency is around \SI{1100}{\hertz} and the highest significant frequency around \SI{4400}{\hertz}, when playing the high C\# note on the guitar, using the bridge pickup.
...
On  \autoref{fig:appendix:high_E_bridge_flasholet} it is seen that the lowest significant frequency is around \SI{1300}{\hertz} and the highest significant frequency around \SI{2600}{\hertz}, when playing the high E note on the guitar as flasholet, using the bridge pickup.
