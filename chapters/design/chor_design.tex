...
\includeCode{flanger.asm}{assembly}{12}{24}{The first step in the flanger code}{code:flang_code1}{code/design/}
...
This is why two tests are being made, a sign test followed by another one to test the monotony. Redirection is made to the appropriate case depending on the results in those tests. \\
\includeCode{flanger.asm}{assembly}{26}{30}{The Sign Test}{code:flang_code2}{code/design/}
\includeCode{flanger.asm}{assembly}{32}{37}{A Monotony Test in the positive case}{code:flang_code3}{code/design/} 
...
\includeCode{flanger.asm}{assembly}{47}{58}{Calculation of $\Delta Y$ and $\Delta X$ in one of the cases}{code:flang_code4}{code/design/}
