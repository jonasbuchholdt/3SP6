...
The first step in the code is the well positioning in the memory map and reseting the position of the pointer (line xx to xx) and getting the variables needed for the calculation from the CORDIC.\\ 
