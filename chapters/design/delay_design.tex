...
\includeCode{reverb.asm}{assembly}{68}{79}{The reverb \gls{lpcf} code}{code:reverb_lpcf_coeff}{code/design/}
...
\end{picture}%
	\caption{The figure shows the memory map of the \gls{reverb}}
