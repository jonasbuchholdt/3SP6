\section{Design of the Delay and \gls{reverb} Effect}\label{sec:rev_del}
...
To change the comb filter caretictica, so the magnitude in the high frequency is lower than the magnitude in the low frequency, $a$ needs to be changed to a low pass filter. The low pass filter have the following transfer function \autoref{eq:comb_filter_lp} 

\begin{equation}\label{eq:comb_filter_lp}
G(z)=f \frac{1-d}{1-d \cdot z^1}
\end{equation}
 
Which gives the final transfer function of the \gls{lpcf} \autoref{eq:comb_filter_lp_final}

 \begin{equation}\label{eq:comb_filter_lp_final}
H(z)=\frac{1}{1-f \frac{1-d}{1-d \cdot z^1} \cdot z^d}
\end{equation}
...
\put(6121,434){\makebox(0,0)[lb]{\smash{{\SetFigFont{12}{14.4}{\rmdefault}{\mddefault}{\updefault}{\color[rgb]{0,0,0}S}%
}}}}
\put(7651,434){\makebox(0,0)[lb]{\smash{{\SetFigFont{12}{14.4}{\rmdefault}{\mddefault}{\updefault}{\color[rgb]{0,0,0}14 Fraction bit}%
}}}}
\put(6346,434){\makebox(0,0)[lb]{\smash{{\SetFigFont{12}{14.4}{\rmdefault}{\mddefault}{\updefault}{\color[rgb]{0,0,0}X}%
}}}}
...
\includeCode{main_buffer.asm}{assembly}{31}{45}{The reverb coeff code}{code:reverb_coeff}{code/design/}
