...
\includeCode{echo_1_all_pass.m}{matlab}{6}{23}{The reverb echo calculation matlab code}{code:close}{code/design/}\label{code:reverb_cal}
...
\begin{equation}\label{eq:reverb_seriel}
 ...
 \end{subequations}
    ...
    \startexplain
\explain{$19$ is calculated from the \gls{lpcf} which is attenuated 10 percent }{\si{1}}
\explain{$19$ is calculated from the \gls{lpcf} which is attenuated 20 percent}{\si{1}}
\explain{$18$ is calculated from the \gls{lpcf} which is attenuated 30 percent }{\si{1}}
\explain{$18$ is calculated from the \gls{lpcf} which is attenuated 40 percent }{\si{1}}
\explain{$17$ is calculated from the \gls{lpcf} which is attenuated 50 percent }{\si{1}}
    \stopexplain
...
\includeCode{reverb.m}{matlab}{1}{80}{The reverb simulation matlab code}{code:close}{code/design/}\label{code:reverb_sim}
