...
\begin{requirement}\label{req:delay_time}
    \requirement{The delay unit must delay the input signal, in time defined by internal preset}
    \argument{In order to be able to change the delay in the \gls{reverb} unit}
\end{requirement}
