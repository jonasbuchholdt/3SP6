...
\begin{requirement}\label{req:equalizer}
    \requirement{The gain of each individual band in the equalizer must be changeable to the user.}
    \argument{In order to give the use the possibility of equalizing the sound as wanted.}
\end{requirement}
